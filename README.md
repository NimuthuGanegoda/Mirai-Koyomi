...
> 💡 **Note**: Always use the **HTTPS** `raw.githubusercontent.com` link to avoid insecure connection warnings and ensuring the direct `.ics` file is delivered to your application. For Apple devices, clicking the Webcal link will automatically prompt you to subscribe. Furthermore, when you subscribe via your device calendar, updates to the master ICS link will be synced to your calendar in real-time.
